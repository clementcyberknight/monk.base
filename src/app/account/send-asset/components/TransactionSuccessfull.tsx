  ...
  return (
    <div className="flex flex-col items-center justify-between flex-grow w-full max-w-md text-[#F7F0D9] py-8 text-center">
      <div className="flex flex-col items-center flex-1 justify-center">
        ...
        <p className="text-sm text-[#A0A0A0] max-w-[300px] mx-auto leading-relaxed">
          {message}
        </p>
      </div>
      <div className="w-full space-y-4 mt-10">
        <button
          ...
          className="w-full bg-[#2C2C2B] rounded-xl p-4 flex items-center justify-center gap-2 cursor-pointer hover:bg-[#3a3a3a] transition-colors text-lg font-semibold"
        >
          Download Receipt
          <svg
      ...
      <div className="w-full mt-12">
        <button
          onClick={onComplete}
          className="w-full bg-[#FFBB03] hover:bg-[#FFBB03]/90 text-[#1E1E1E] py-4 rounded-xl text-xl font-semibold transition-colors"
        >
          Complete
        </button>
      </div>
